...
SymbolResolver::SymbolResolver()
{
    ...
    m_VTables["memchr"] = reinterpret_cast<void *>(static_cast<void*(*)(void*, int, size_t)>(memchr));
    ...
    m_VTables["strchr"] = reinterpret_cast<void *>(static_cast<char*(*)(char*, int)>(strchr));
    m_VTables["strrchr"] = reinterpret_cast<void *>(static_cast<char*(*)(char*, int)>(strrchr));
    m_VTables["strstr"] = reinterpret_cast<void *>(static_cast<char*(*)(char*, const char*)>(strstr));
    ...
    m_VTables["strpbrk"] = reinterpret_cast<void *>(static_cast<char*(*)(char*, const char*)>(strpbrk));
